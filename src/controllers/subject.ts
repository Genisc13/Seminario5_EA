...
import { insertSubject,getSubject,getSubjects,updateSubject,deleteSubject, matriculateSubject,getUsers} from "../services/subject";
...
export{get_Subject,get_Subjects,post_Subject,update_Subject,delete_Subject,matriculate_Subject,get_Users};