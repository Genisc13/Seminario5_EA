...
import { delete_Subject,get_Subject,get_Subjects,matriculate_Subject,post_Subject, update_Subject ,get_Users} from "../controllers/subject";
...
router.get("/users/:idSubject",get_Users);
